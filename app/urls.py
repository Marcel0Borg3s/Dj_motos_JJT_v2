...
from motos.views import MotoDeleteView, MotoDetailView, MotosListView, MotoUpdateView, NewMotoCreateView
...
urlpatterns = [
    ...
    path('motos/<int:pk>/delete/', MotoDeleteView.as_view(), name='moto_delete'),
